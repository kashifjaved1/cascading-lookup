...
namespace CascadingLookup.Controllers
{
    public class AreasController : Controller
    {
        ...
        {
            var appDbContext = _context.Areas.Include(a => a.City);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CityId")] Area area)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CityId")] Area area)
        {
            if (id != area.Id)
            {
                return NotFound();
